...
class SignUpPage(tk.Frame):
    def __init__(self, master):
        ...
        self.label_username = tk.Label(self, text="New Username:")
        self.label_password = tk.Label(self, text="New Password:")
        ...
        self.button_login = tk.Button(self, text="Switch to Login", command=lambda: master.switch_to_login())

        self.button_signup.grid(row=2, column=1, pady=10)
    ...
    def signup(self):
        ...
        messagebox.showinfo("Sign Up Successful", "Account created for {}".format(new_username))
